	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>Beautiful Bouquet</b></h3>
					<p>Jl. G Obos XII Palangka raya</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +628098999</p>
					<p><i class="glyphicon glyphicon-envelope"></i> buket@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
		...
		<div class="copy" style="background-color: #ff8680; padding: 5px; color: #fff; text-align: center;">
			<span>Copyright&copy; Anggri L. Djatta</span>
		</div>
	</footer>
