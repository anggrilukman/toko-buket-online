		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Contoh : tangkai atau ikat" name="satuan">
						<p class="help-block">Hanya Masukkan Satuan saja : tangkai atau ikat</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<p class="help-block">Harga termasuk harga per tangkai atau per ikat</p>
				</div>
			</div>
		</div>
