		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="hidden" class="form-control" id="exampleInputEmail1" placeholder="Contoh : tangkai atau ikat" name="kd_material" value="<?= $row['kode_bk']; ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Contoh : ikat" name="satuan" value="<?= $row['satuan']; ?>">
					<p class="help-block">Hanya Masukkan Satuan saja : Ikat atau Tangkai</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<p class="help-block">Harga termasuk harga per Ikat atau per tangkai</p>
				</div>
			</div>
		</div>
