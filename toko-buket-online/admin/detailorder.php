...
<div class="container">
	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<?php 
			$result = mysqli_query($conn, "SELECT invoice, kode_customer, status, kode_produk, qty, terima, tolak, cek, tanggal FROM produksi GROUP BY invoice, kode_customer, status, kode_produk, qty, terima, tolak, cek, tanggal");
